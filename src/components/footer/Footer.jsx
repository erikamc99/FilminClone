      ...
      <section className="footerSection">
        ...
        <div className="upperSection">
          <div className="upperLinks">
            <a href="https://ayuda.filmin.es/es/support/home" target="_blank" rel="noreferrer">
              Centro de ayuda
            </a>
            <a href="https://www.filmin.es/aviso-legal" target="_blank" rel="noreferrer">
              Aviso Legal
            </a>
            <a href="https://shorturl.at/fKlnU" target="_blank" rel="noreferrer">
              Prensa
            </a>
          </div>
